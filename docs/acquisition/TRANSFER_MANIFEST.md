# Transfer manifest â€” Project Atmospheric Ultra-Clean

## Schedule A â€” Included (typical)

1. Git repository `theworker02/AUC-project` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Project Atmospheric Ultra-Clean
